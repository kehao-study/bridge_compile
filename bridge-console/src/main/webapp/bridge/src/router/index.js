  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/config_file_manager',
          component: resolve => require(['../components/page/ConfigFileManager.vue'], resolve)
        },
        {
          path: '/config_file_operateLog_manager',
          component: resolve => require(['../components/page/ConfigFileOperateLogManager.vue'], resolve)
