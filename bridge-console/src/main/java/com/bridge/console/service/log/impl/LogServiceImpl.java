...
public class LogServiceImpl implements LogService {
     ...
     */
    @Override
    public void pushConsoleLog(String logContent, LogLevelEnum logLevelEnum, Integer envId,
        ...
        try {
            ...
            SystemLogDO systemLogDO = new SystemLogDO();
            systemLogDO.setIsDeleted(BaseBizEnum.YN_N.getCode());
            systemLogDO.setEnvId(envId);
            systemLogDO.setAppCode(appCode);
            systemLogDO.setClientIp(NodePathUtils.getIp());
            systemLogDO.setAppName(appName);
            ...
            systemLogVO.setAppCode(appCode);
            WebSocketServer.sendLog(systemLogVO);
        } catch (Exception e) {
