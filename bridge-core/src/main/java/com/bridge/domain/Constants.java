...
public final class Constants {
     ...
     * 建立一个持久节点作为锁的root节点
     */
    public static final String ROOT = "/zk_bridge_config_root";

    /**
     * 开发环境
     */
    public static final String DEV_ROOT = ROOT.concat("/dev");

    /**
     * 测试环境
     */
    public static final String TEST_ROOT = ROOT.concat("/test");

    /**
     * 预发环境
     */
    public static final String STABLE_ROOT = ROOT.concat("/stable");

    /**
     * 线上环境
     */
    public static final String ONLINE_ROOT = ROOT.concat("/online");
