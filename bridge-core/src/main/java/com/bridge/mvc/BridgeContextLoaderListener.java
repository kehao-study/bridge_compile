...
public class BridgeContextLoaderListener extends ContextLoaderListener implements ServletContextListener {
     ...
     * 是否开启配置中心，默认为开启
     */
    private static final String SERVER_ENABLE_PROPERTY_NAME = SPRING_BRIDGE_ENABLE;
    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        ...
        try {
            ...
            String enable = properties.getProperty(SERVER_ENABLE_PROPERTY_NAME);
            ...
            if (StringUtils.isNotEmpty(enable) && !system.containsKey(SERVER_ENABLE_PROPERTY_NAME)) {
                System.setProperty(SERVER_ENABLE_PROPERTY_NAME, enable);
            } else {
                // 默认开启配置中心
                System.setProperty(SERVER_ENABLE_PROPERTY_NAME, Boolean.TRUE.toString());
            }
